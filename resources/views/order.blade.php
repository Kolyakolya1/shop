    ...
    <div class="starter-template">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <p>Общая стоимость: <b>89990 руб.</b></p>
                <form action="http://internet-shop.tmweb.ru/basket/place" method="POST">
                    <div>
                        ...
                        <br>
                        <input type="hidden" name="_token" value="7vsDmxYxO9ZgF2rkhXEY3TuXybn84QSf68qxpVL0">                    <input type="submit" class="btn btn-success" value="Подтвердите заказ">
                    </div>
                </form>
            </div>
        </div>
